...
CREATE INDEX resource_characteristic_Iresource_id on [resource_characteristic] ([resource_id])
 ...
 ALTER TABLE [service_characteristic] ADD CONSTRAINT [service_characteristic_Fservice_0] FOREIGN KEY ([service_id_m0]) REFERENCES [service]
CREATE INDEX service_characteristic_Iservice_id_m0 on [service_characteristic] ([service_id_m0])

 ALTER TABLE [service_characteristic] ADD CONSTRAINT [service_characteristic_Fservice_1] FOREIGN KEY ([service_id]) REFERENCES [service]
...
CREATE INDEX service_order_Icustomer_id_m0 on [service_order] ([customer_id_m0])
 ...
 ALTER TABLE [service_order] ADD CONSTRAINT [service_order_Fusr_0] FOREIGN KEY ([creator_id]) REFERENCES [usr]
...
CREATE INDEX service_order_Istate on [service_order] ([state])
 ...
 ALTER TABLE [service_order] ADD CONSTRAINT [service_order_Fusr_1] FOREIGN KEY ([modifier_id]) REFERENCES [usr]
...
CREATE INDEX order_item_Iclone_service_id_m0 on [order_item] ([clone_service_id_m0])
 ...
 ALTER TABLE [order_item] ADD CONSTRAINT [order_item_Fusr_0] FOREIGN KEY ([creator_id]) REFERENCES [usr]
...
CREATE INDEX order_item_Iservice_order_id on [order_item] ([service_order_id])
 ...
 ALTER TABLE [order_item] ADD CONSTRAINT [order_item_Fservice_1] FOREIGN KEY ([service_id]) REFERENCES [service]
...
CREATE INDEX order_item_Iparent_id on [order_item] ([parent_id])
 ...
 ALTER TABLE [order_item] ADD CONSTRAINT [order_item_Fservice_2] FOREIGN KEY ([service_id_m0]) REFERENCES [service]
CREATE INDEX order_item_Iservice_id_m0 on [order_item] ([service_id_m0])

 ALTER TABLE [order_item] ADD CONSTRAINT [order_item_Fusr_1] FOREIGN KEY ([creator_id_m0]) REFERENCES [usr]
...
CREATE INDEX service_spec_characteristic_Idictionary_id on [service_spec_characteristic] ([dictionary_id])
 ...
 ALTER TABLE [service_spec_characteristic] ADD CONSTRAINT [service_spec_characteristic_Fdictionary_1] FOREIGN KEY ([dictionary_id_m0]) REFERENCES [dictionary]
...
CREATE INDEX resource_Iresource_spec_id_m0 on [resource] ([resource_spec_id_m0])
 ...
 ALTER TABLE [customer_acl] ADD CONSTRAINT [customer_acl_Fcustomer_0] FOREIGN KEY ([customer_id_m0]) REFERENCES [customer]
CREATE INDEX customer_acl_Icustomer_id_m0 on [customer_acl] ([customer_id_m0])

 ALTER TABLE [customer_acl] ADD CONSTRAINT [customer_acl_Fcustomer_1] FOREIGN KEY ([customer_id]) REFERENCES [customer]
