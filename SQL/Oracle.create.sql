...
ALTER TABLE "resource_spec_characteristic"
	ADD CONSTRAINT "resource_spec_characteris_6528" FOREIGN KEY ("dictionary_id_m0") REFERENCES "dictionary" ("primaryKey");

CREATE INDEX "resource_spec_characteris_7813" on "resource_spec_characteristic" ("dictionary_id_m0");

ALTER TABLE "resource_spec_characteristic"
	ADD CONSTRAINT "resource_spec_characteris_6529" FOREIGN KEY ("dictionary_id") REFERENCES "dictionary" ("primaryKey");
...
ALTER TABLE "resource_spec"
	ADD CONSTRAINT "resource_spec_Fresource_c_9602" FOREIGN KEY ("resource_common_id_m0") REFERENCES "resource_common" ("primaryKey");
...
ALTER TABLE "service_characteristic"
	ADD CONSTRAINT "service_characteristic_Fs_8759" FOREIGN KEY ("service_id_m0") REFERENCES "service" ("primaryKey");

CREATE INDEX "service_characteristic_Is_7989" on "service_characteristic" ("service_id_m0");

ALTER TABLE "service_characteristic"
	ADD CONSTRAINT "service_characteristic_Fs_8760" FOREIGN KEY ("service_id") REFERENCES "service" ("primaryKey");
...
ALTER TABLE "service_spec"
	ADD CONSTRAINT "service_spec_Fservice_spec_1" FOREIGN KEY ("parent_id") REFERENCES "service_spec" ("primaryKey");
...
ALTER TABLE "service"
	ADD CONSTRAINT "service_Fservice_state_1" FOREIGN KEY ("state") REFERENCES "service_state" ("primaryKey");
...
ALTER TABLE "service"
	ADD CONSTRAINT "service_Fcontragent_1" FOREIGN KEY ("contragent_id_m0") REFERENCES "contragent" ("primaryKey");

CREATE INDEX "service_Icontragent_id_m0" on "service" ("contragent_id_m0");

ALTER TABLE "service"
	ADD CONSTRAINT "service_Fservice_2" FOREIGN KEY ("cfs_id") REFERENCES "service" ("primaryKey");
...
ALTER TABLE "service_usage_spec"
	ADD CONSTRAINT "service_usage_spec_Fchara_5383" FOREIGN KEY ("type_m0") REFERENCES "characteristic_type" ("primaryKey");

CREATE INDEX "service_usage_spec_Itype_m0" on "service_usage_spec" ("type_m0");

ALTER TABLE "service_usage_spec"
	ADD CONSTRAINT "service_usage_spec_Fchara_5384" FOREIGN KEY ("type") REFERENCES "characteristic_type" ("primaryKey");
...
ALTER TABLE "service_order"
	ADD CONSTRAINT "service_order_Fusr_0" FOREIGN KEY ("creator_id") REFERENCES "usr" ("primaryKey");
...
ALTER TABLE "service_order"
	ADD CONSTRAINT "service_order_Fusr_1" FOREIGN KEY ("modifier_id") REFERENCES "usr" ("primaryKey");

CREATE INDEX "service_order_Imodifier_id" on "service_order" ("modifier_id");

ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fservice_0" FOREIGN KEY ("clone_service_id_m0") REFERENCES "service" ("primaryKey");

CREATE INDEX "order_item_Iclone_service_7527" on "order_item" ("clone_service_id_m0");

ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fusr_0" FOREIGN KEY ("creator_id") REFERENCES "usr" ("primaryKey");
...
ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fservice_1" FOREIGN KEY ("service_id") REFERENCES "service" ("primaryKey");
...
ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fservice_2" FOREIGN KEY ("service_id_m0") REFERENCES "service" ("primaryKey");

CREATE INDEX "order_item_Iservice_id_m0" on "order_item" ("service_id_m0");

ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fusr_1" FOREIGN KEY ("creator_id_m0") REFERENCES "usr" ("primaryKey");
...
ALTER TABLE "order_item"
	ADD CONSTRAINT "order_item_Fusr_2" FOREIGN KEY ("modifier_id") REFERENCES "usr" ("primaryKey");
...
ALTER TABLE "service_spec_characteristic"
	ADD CONSTRAINT "service_spec_characteristi_328" FOREIGN KEY ("dictionary_id_m0") REFERENCES "dictionary" ("primaryKey");
...
ALTER TABLE "resource"
	ADD CONSTRAINT "resource_Fservice_2" FOREIGN KEY ("cfs_id_m0") REFERENCES "service" ("primaryKey");
...
ALTER TABLE "customer_acl"
	ADD CONSTRAINT "customer_acl_Fcustomer_0" FOREIGN KEY ("customer_id_m0") REFERENCES "customer" ("primaryKey");

CREATE INDEX "customer_acl_Icustomer_id_m0" on "customer_acl" ("customer_id_m0");

ALTER TABLE "customer_acl"
	ADD CONSTRAINT "customer_acl_Fcustomer_1" FOREIGN KEY ("customer_id") REFERENCES "customer" ("primaryKey");
...
ALTER TABLE "customer_acl"
	ADD CONSTRAINT "customer_acl_Fgrp_1" FOREIGN KEY ("group_id") REFERENCES "grp" ("primaryKey");
